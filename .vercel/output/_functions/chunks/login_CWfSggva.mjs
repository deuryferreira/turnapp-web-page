...
<a href="https://calendar.app.google/66gajcn26cj5iZVB7" target="_blank" rel="noopener noreferrer" class="font-medium text-payflo-purple hover:text-payflo-purple/80" data-astro-cid-sgpqyurt>
Book a demo
</a> </p> </div> </div> ` })}`;
}, "C:/Users/Ferreira_x2/Desktop/dev/turnapp-web-page/src/pages/login.astro", void 0);

const $$file = "C:/Users/Ferreira_x2/Desktop/dev/turnapp-web-page/src/pages/login.astro";
const $$url = "/login";
