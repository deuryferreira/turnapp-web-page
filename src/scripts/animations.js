...
// ===== Event Listeners for Astro 5.7 =====
// Para navegación SPA (View Transitions)
document.addEventListener("astro:after-swap", () => {
  initializeApp();
});

// Para carga inicial y navegación normal
document.addEventListener("DOMContentLoaded", () => {
  initializeApp();
});

// Fallback: también ejecutar cuando la página esté completamente cargada
